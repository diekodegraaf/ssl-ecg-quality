...
class TGaussianNoise(Transformation):
    """Modified. Add gaussian noise to sample.
    """
...
class TDynamicTimeWarp(Transformation):
    """Custom TimeWarp. Stretch and squeeze signal randomly along time axis as described in the instructions."""
...
class TBaselineWander(Transformation):
    """Modified. Adds baseline wander to the sample.
    """
...
class TEMNoise(Transformation):
    """Modified Adds electromyographic (EM) hf noise to the sample.
    """
...
# class TEMNoise(Transformation):
#     """Adds electromyographic (EM) hf noise to the sample.
#     """
